...
<nav>
  ...
  <a href=ex25tab2.php?categ=hommes>Hommes</a>
  <a href=ex25tab2.php?categ=femmes>Femmes</a>
  <a href=ex25tab2.php?categ=enfants>Enfants</a>
...
foreach($resultat as $cle => $valeur) {
 // echo "<h1>".$cata[1];
  echo "<h2>".$valeur['nom_produit']."</h2><img src=http://".$valeur["photo"]."><p>".$valeur['prix']."</p>" ;
  echo "<hr>";
}
